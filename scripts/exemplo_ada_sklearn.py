...
##### Adaline from Sklearn #####
from sklearn.linear_model import SGDClassifier
# passar parâmetros
ada = SGDClassifier(max_iter=500, random_state=1)
# treinar com os dados
ada.fit(X, y)

# plotar dados, superfície de decisão e margem
plot_decision_regions(X=X, y=y, classifier=ada, test_idx=None)
plt.xlabel('x1')
plt.ylabel('x2')
plt.title("Adaline")
plt.savefig("figures/iris_sklearn_adaline.png")